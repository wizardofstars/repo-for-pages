(function () {
  ...
  Lampa.Lang.add({
    ...
    reset_to_default: {
      ru: "Noklusējuma iestatījumi",
      en: "Noklusējuma iestatījumi",
      lv: "Noklusējuma iestatījumi",
      be: "Скінуць па змаўчанні",
    },

    show_en: {
      ru: 'Rādīt nosaukumu <img src="https://flagcdn.com/us.svg" style="width:1.15em;height:auto;vertical-align:middle;"> angliski',
      en: 'Rādīt <img src="https://flagcdn.com/us.svg" style="width:1.15em;height:auto;vertical-align:middle;"> angliski',
      lv: 'Rādīt <img src="https://flagcdn.com/us.svg" style="width:1.15em;height:auto;vertical-align:middle;"> angliski',
      be: 'Паказваць <img src="https://flagcdn.com/us.svg" style="width:1.15em;height:auto;vertical-align:middle;"> EN',
    },

    show_tl: {
      ru: "Rādīt tulkojumu (transliteration)",
      en: "Rādīt tulkojumu (transliteration)",
      lv: "Rādīt tulkojumu (transliteration)",
      be: "Паказваць Romaji (transliteration)",
    },

    show_lv: {
      ru: 'Rādīt nosaukumu <img src="https://flagcdn.com/lv.svg" style="width:1.15em;height:auto;vertical-align:middle;"> latviski',
      en: 'Rādīt <img src="https://flagcdn.com/lv.svg" style="width:1.15em;height:auto;vertical-align:middle;"> latviski',
      lv: 'Rādīt <img src="https://flagcdn.com/lv.svg" style="width:1.15em;height:auto;vertical-align:middle;"> latviski',
      be: 'Паказваць <img src="https://flagcdn.com/lv.svg" style="width:1.15em;height:auto;vertical-align:middle;"> LV',
    },

    show_be: {
      ru: 'Rādīt nosaukumu <img src="https://flagcdn.com/by.svg" style="width:1.15em;height:auto;vertical-align:middle;"> baltkrieviski',
      en: 'Rādīt <img src="https://flagcdn.com/by.svg" style="width:1.15em;height:auto;vertical-align:middle;"> baltkrieviski',
      lv: 'Rādīt <img src="https://flagcdn.com/by.svg" style="width:1.15em;height:auto;vertical-align:middle;"> baltkrieviski',
      be: 'Паказваць <img src="https://flagcdn.com/by.svg" style="width:1.15em;height:auto;vertical-align:middle;"> BE',
    },
    show_ru: {
      ru: 'Rādīt nosaukumu <img src="https://flagcdn.com/ru.svg" style="width:1.15em;height:auto;vertical-align:middle;"> krieviski',
      en: 'Rādīt <img src="https://flagcdn.com/ru.svg" style="width:1.15em;height:auto;vertical-align:middle;"> krieviski',
      lv: 'Rādīt <img src="https://flagcdn.com/ru.svg" style="width:1.15em;height:auto;vertical-align:middle;"> krieviski',
      be: 'Паказваць <img src="https://flagcdn.com/ru.svg" style="width:1.15em;height:auto;vertical-align:middle;"> RU',
    },
  });

  const LANGS = ["en", "tl", "lv", "be", "ru"];
  ...
  function startPlugin() {
    ...
    Lampa.SettingsApi.addParam({
      ...
      field: {
        ...
        description: "Filmu Nosaukumu iestatījumi",
      },
      onChange: openEditor,
    });
    ...
    `;
      ...
      if (!ru || !en || !translit || !lv || !be) {
        try {
          ...
          translit =
            ...
            translit;
          // Universal function to lookup language/country
        ...
        lv ||= alt.find((t) => t.iso_3166_1 === "LV")?.title;
      ...
      const lines = [
        `<div style="font-size:1.75em;">${orig}  ${countryFlag(
      ...
      showOrder.forEach((lang) => {
        ...
        const val = lang === "tl" ? translit : { en, lv, be, ru }[lang];
        if (val)
          lines.push(
            `<div style="font-size:1.75em;">${val} ${countryFlag(
              { ru: "RU", en: "US", lv: "LV", be: "BY" }[lang]
            )}
            </div>`
          );
      });
